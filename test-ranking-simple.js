/**
 * Simplified test script for ranking content generation
 * Uses a broader topic more likely to match existing articles
 * Run: node test-ranking-simple.js
 */
...
async function testRankingGeneration() {
  ...
  console.log('Topic: Top 5 meilleures équipes africaines\n');

  const requestBody = {
    contentType: 'ranking',
    locale: 'fr',
    params: {
      topic: 'Top 5 meilleures équipes africaines',
      criteria: 'Performances récentes, palmarès, niveau des joueurs',
      count: 5,
      region: 'Afrique',
      timeframe: '2024-2025'
    }
