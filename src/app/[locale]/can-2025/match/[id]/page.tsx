...
export async function generateMetadata({
  ...
  // Canonical URL (always French version)
  const canonicalUrl = `${SITE_URL}/fr/can-2025/match/${id}`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        'fr-FR': `${SITE_URL}/fr/can-2025/match/${id}`,
...
/**
 * Generate static params for pre-rendering (optional, for better performance)
 */
export async function generateStaticParams() {
  // Could fetch all CAN 2025 match IDs from ESPN or Supabase
