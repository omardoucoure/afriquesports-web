    ...
    <html suppressHydrationWarning className={rubik.variable}>
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `
              // Only initialize PostHog on production domains
              ...
              if (isProduction) {
                ...
                posthog.init('${process.env.NEXT_PUBLIC_POSTHOG_KEY}',{
                  ...
                  loaded:function(ph){console.log('[PostHog] Loaded successfully (Production)');ph.capture('posthog_loaded',{timestamp:Date.now()});}
                });
              } else {
                console.log('[PostHog] Skipped initialization (not production domain)');
              }
            `
          }}
        />
