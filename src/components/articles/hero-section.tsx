...
function FeaturedHeroCard({
  ...
  return (
    <article className="relative h-full min-h-[400px] lg:min-h-[480px] overflow-hidden group">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:min-h-[480px]">
      ...
      <div className="hidden lg:flex lg:flex-col lg:col-span-3">
        <div className="flex items-center gap-2 mb-4">
          <span className="bg-[#04453f] text-white text-xs font-bold px-3 py-1">
      ...
      <div className="hidden lg:flex lg:flex-col lg:col-span-3">
        ...
        <div className="flex-1 flex flex-col justify-between gap-4">
          {rightArticles.slice(0, 2).map((article, index) => (
            <TrendingCard
              key={article.id}
              article={article}
              index={index + 1}
      ...
      {/* Mobile: Show trending and latest below */}
...
export function HeroSectionSkeleton() {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:min-h-[480px]">
      {/* Left column skeleton - matches TrendingCard */}
      <div className="hidden lg:flex lg:flex-col lg:col-span-3">
        <div className="flex items-center gap-2 mb-4">
          <div className="bg-gray-200 h-6 w-24 animate-pulse" />
          <div className="flex-1 h-0.5" style={{ background: 'linear-gradient(90deg, rgba(9,121,28,1) 0%, rgba(219,217,97,1) 37%, rgba(255,0,0,1) 88%)' }} />
        </div>
        <div className="flex-1 flex flex-col justify-between gap-4">
          {[1, 2].map((i) => (
      ...
      <div className="hidden lg:flex lg:flex-col lg:col-span-3">
        <div className="flex items-center gap-2 mb-4">
          <div className="bg-gray-200 h-6 w-20 animate-pulse" />
          <div className="flex-1 h-0.5" style={{ background: 'linear-gradient(90deg, rgba(9,121,28,1) 0%, rgba(219,217,97,1) 37%, rgba(255,0,0,1) 88%)' }} />
        </div>
        <div className="flex-1 flex flex-col justify-between gap-4">
          {[1, 2].map((i) => (
