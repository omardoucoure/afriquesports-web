...
export function ShareButtons({ url, title }: ShareButtonsProps) {
  ...
  return (
    <div className="flex items-center flex-wrap gap-2 sm:gap-3">
      <span className="text-sm font-medium text-gray-500 hidden sm:inline">Partager :</span>
      ...
      <button
        onClick={handleCopy}
        className="w-10 h-10 sm:w-9 sm:h-9 flex items-center justify-center bg-gray-200 text-gray-600 rounded-full hover:bg-gray-300 transition-colors active:scale-95 relative"
