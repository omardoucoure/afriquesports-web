...
export function MobileNav({ isOpen, onClose, navigation }: MobileNavProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 lg:hidden">
      ...
      {/* Drawer */}
      <div className="absolute top-0 right-0 bottom-0 w-full max-w-sm bg-white shadow-xl animate-in slide-in-from-right duration-300">
        {/* Header */}
          ...
          <div className="mt-8 pt-6 border-t">
            ...
            <div className="flex items-center gap-3 px-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center text-gray-600 hover:bg-gradient-to-br hover:from-[#833AB4] hover:via-[#FD1D1D] hover:to-[#F77737] hover:text-white transition-colors"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center text-gray-600 hover:bg-[#FF0000] hover:text-white transition-colors"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
